...
<html lang="en">
  <head>
    ...
    <link rel="ICON" href="images/agriculture.png" type="image/ico" />

    <title>Agriculture Supply Chain DApp</title>
  ...
  <body class="violetgradient">
            ...
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off">
                    <div class="formitem">
                      ...
                      <div>
                        <label type="text" class="formlabel"> Quantity </label>
                        <div class="row quant-container">
                          <input type="text" class="forminput col-8" id="quantity" required>
                          <select id="quantity-unit" name="quantity-unit" class="forminput col-4 quanti-type-options" ">
                            <option value="kilogram">Kilogram (kg)</option>
                            <option value="gam">Gram (gr)</option>
                      ...
                      <div>
                        <label type="text" class="formlabel"> Price </label>
                        <div class="row quant-container">
                          <input type="text" class="forminput col-8" id="price" required>
                          <select id="price-unit" name="quantity-unit" class="forminput col-4 quanti-type-options" ">
                      ...
                      <div>
                        <label type="text" class="formlabel"> Expiry Date </label>
                        <input type="date" class="forminput" id="expdate" name="birthday">
                      </div>
                    </div>
    ...
    $('#form1').on('submit', function(event) {
        ...
        quantity_unit = $('#quantity-unit').val();

        price    = $('#price').val();
        price_unit = $('#price-unit').val();

        expdate  = $('#expdate').val();
        
        prodname = "<span class='prod_value col-6'>"+prodname+"</span></div>"+
        "<div class='row'>  <span class='prod_property col-6'>Registered By: </span>" +"<span class='prod_value col-6'>"+username+"</span></div>"+
        "<div class='row'>  <span class='prod_property col-6'>Quantity: </span>"      +"<span class='prod_value col-6'>"+quantity+" ("+quantity_unit+")"+"</span></div>"+
        "<div class='row'>  <span class='prod_property col-6'>Price: </span>"         +"<span class='prod_value col-6'>"+price+ " ("+price_unit+")"+"</span></div>"+
        "<div class='row'>  <span class='prod_property col-6'>Expiry Date: </span>"   +"<span class='prod_value col-6'>"+expdate+"</span></div>";

        console.log(prodname);
        var today = new Date();
        var thisdate = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
        thisdate = "<span class='prod_value col-6'>"+thisdate+"</span></div><br><br>";
