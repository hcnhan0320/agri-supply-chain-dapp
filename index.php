  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h2>Welcome to our project <br> Agriculture Supply Chain DApp</h2>
      ...
      <div class="loginformcard" id="maincard3">
            ...
            <select class="formselect" name="role">
              ...
              <option value="1" style="display: none">Retailer</option>
              <option value="1" style="display: none">Distributor</option>
