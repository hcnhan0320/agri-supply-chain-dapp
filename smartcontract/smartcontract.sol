...
contract SupplyChain {
    ...
    function searchProduct(uint _productId) public view returns (string memory) {
        ...
        require(_productId<=items);
        string memory output="<div class='row'><span class='prod_property col-6'>Product Name: </span>";
        output=concat(output, allProducts[_productId].productName);
        output=concat(output, "<div class='row'><span class='prod_property col-6'>Manufacture Date: </span>");
